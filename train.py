...
y_train= np.load("y_train.npy")>=2

x_valid=  np.load("x_test.npy")
y_valid=  np.load("y_test.npy")>=2
...
filepath="weights-improvement-model_3-{epoch:02d}.h5"
...
plt.title('COVID-WideNet accuracy')
plt.ylabel('accuracy')
plt.xlabel('epoch')
